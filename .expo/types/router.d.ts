...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(routes)/coursedetails` | `/(routes)/home` | `/(routes)/login` | `/Core/api` | `/Core/api/commoApi` | `/Core/constants` | `/Core/constants/api_url` | `/Navigations/homeNavigation` | `/_sitemap` | `/context/authContext` | `/coursedetails` | `/home` | `/login` | `/redux/reducer` | `/redux/reducer/auth` | `/redux/reducer/common` | `/redux/store`;
